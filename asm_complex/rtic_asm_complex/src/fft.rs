...
*/
pub fn fft(y:[ComplexNum; FRAME_LENGTH]) -> [ComplexNum; FRAME_LENGTH]{
    ...
    for m in 1..n+1{
        for z in 0..(1 << m-1){
            ...
            let e = ComplexNum::new(co.cos(), si.sin());
...
pub fn frames_fft(input_frames : [[ComplexNum; FRAME_LENGTH];NUMBER_OF_FRAMES]) ->[[ComplexNum; FRAME_LENGTH];NUMBER_OF_FRAMES]{
    let mut out = [[ComplexNum::new(0.0,0.0);FRAME_LENGTH];NUMBER_OF_FRAMES];
...
*/
pub fn mybitrev(array:[ComplexNum; FRAME_LENGTH]) -> [ComplexNum;FRAME_LENGTH]{
    ...
    */
    ...
    let mut a = [ComplexNum::new(0.0,0.0);FRAME_LENGTH];
