...
*/
pub fn fft(y:[Complex<f32>; FRAME_LENGTH]) -> [Complex<f32>; FRAME_LENGTH]{
    ...
    for m in 1..n+1{
        for z in 0..(1 << m-1){
            ...
            let e = Complex::new(co.cos(), si.sin());
...
pub fn frames_fft(input_frames : [[Complex<f32>; FRAME_LENGTH];NUMBER_OF_FRAMES]) ->[[Complex<f32>; FRAME_LENGTH];NUMBER_OF_FRAMES]{
    let mut out = [[Complex::new(0.0,0.0);FRAME_LENGTH];NUMBER_OF_FRAMES];
...
*/
pub fn mybitrev(array:[Complex<f32>; FRAME_LENGTH]) -> [Complex<f32>;FRAME_LENGTH]{
    ...
    */
    ...
    let mut a = [Complex::new(0.0,0.0);FRAME_LENGTH];
