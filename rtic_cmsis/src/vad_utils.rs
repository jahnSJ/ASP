...
*/
pub fn frames_mag(array:[[MyComplex;FRAME_LENGTH];NUMBER_OF_FRAMES]) -> [[f32;FRAME_LENGTH];NUMBER_OF_FRAMES]{
...
*/
pub fn mag(array:[MyComplex;FRAME_LENGTH]) -> [f32;FRAME_LENGTH]{
    let mut out= [0.0;FRAME_LENGTH];

    for i in 0..FRAME_LENGTH{
        let temp = array[i].real * array[i].real + array[i].imaginaer * array[i].imaginaer;
